...
export const metadata = {
  title: 'Figure Drawings | Sarah Vu',
  description: 'Life drawing studies exploring form, light, and gesture.',
};

export default function FigureDrawingsPage() {
  const artworks = getArtworksByCategory('figure-drawings');
  const meta = getCategoryMeta('figure-drawings');
